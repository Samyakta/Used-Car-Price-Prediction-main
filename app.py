...
#PREDICTION
        ...
        return render_template('car.html',prediction_text="The predicted price of car is Rs. {} lakhs. This price may change depending on the condition of the car.".format(output))
